...
public abstract class QuilMarketDataBuilder {
    ...
    private void loadFxRates(ImmutableMarketDataBuilder builder) {
        ...
        builder.addValue(FxRateId.of(com.opengamma.strata.basics.currency.Currency.GBP, com.opengamma.strata.basics.currency.Currency.USD), FxRate.of(com.opengamma.strata.basics.currency.Currency.GBP, com.opengamma.strata.basics.currency.Currency.USD, 1.61));
    }
